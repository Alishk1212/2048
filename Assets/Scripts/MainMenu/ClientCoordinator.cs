...
public class ClientCoordinator : MonoBehaviour 
{
    ...
    public object EventBroker { get; private set; }
    ...
    public T OpenOverlay<T>(bool hasCanvas = false, bool showOnTop = false) where T : Overlay
    {
        ...
        else
        {
            //if (panelCanvas == null)
            //{
            //    if (SceneManager.GetActiveScene().name == SceneNames.sMainMenu)
            //    {
            //        //panelCanvas = MainMenuUI.instance.canvasPanel;
            //    }
            //    else if (SceneManager.GetActiveScene().name == SceneNames.sGame)
            //    {
            //        //panelCanvas = InGameUI.instance.canvasPanel;
            //    }
            //    else
            //}
            ...
            {
                panelCanvas = GameObject.FindGameObjectWithTag("CanvasPanel").GetComponent<Canvas>();
                Debug.Log(SceneManager.GetActiveScene().name);
            }
            else if (SceneManager.GetActiveScene().name == "Gameplay")
            {
                panelCanvas = GameObject.FindGameObjectWithTag("InGameUI").GetComponent<Canvas>();
                Debug.Log(SceneManager.GetActiveScene().name);
            }
            currentOverlayGameobject = Addressables.InstantiateAsync(typeof(T).Name, panelCanvas.transform).WaitForCompletion();
        }
...
public static class SceneNames
{
    ...
    public static readonly string sGame = "Gameplay";
}